...
access to the static web site. Finally, you will learn how to use the
...
the `htmlhint src/www/travels.html` command to "lint" your HTML file.
...
- The `travels.html` file contains the fragment `<title>Share Your Travels</title>`.
- The `travels.html` file contains the fragment `<h1>Share Your Travels</h1>`.
- The `travels.html` file contains the fragment `<h3>Reviews</h3>`.
- The `travels.html` file contains the two of the `<time>` fragment.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-103-S2018/cs103-S2018-lab3-starter.git
```
...
you can go to the [Computer Science 103 Lab 3
Starter](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-lab3-starter)
