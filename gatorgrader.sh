...
if [ "$CHECK" = true ]; then
  ...
  determine_exit_code $? "htmlhint src/www/travels.html"
  htmlhint src/www/travels.html
  echo ""
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles travels.html --fragments "<title>Share Your Travels</title>" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles travels.html --fragments "<h1>Share Your Travels</h1>" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles travels.html --fragments "<h3>Reviews</h3>" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
